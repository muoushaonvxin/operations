    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_groups', models.ManyToManyField(blank=True, to='TimeSpace.HostGroup', verbose_name='主机组')),
                ('hosts', models.ManyToManyField(blank=True, to='TimeSpace.Host', verbose_name='主机')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services', models.ManyToManyField(to='TimeSpace.Service', verbose_name='服务列表')),
            ],
        ),
        migrations.CreateModel(
            name='Trigger',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TimeSpace.Service', verbose_name='关联服务')),
                ('service_index', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TimeSpace.ServiceIndex', verbose_name='关联服务指标')),
                ('trigger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TimeSpace.Trigger', verbose_name='所属触发器')),
            ],
        ),
        migrations.AddField(
            model_name='template',
            name='triggers',
            field=models.ManyToManyField(blank=True, to='TimeSpace.Trigger', verbose_name='触发器列表'),
        ),
        migrations.AddField(
            model_name='service',
            name='items',
            field=models.ManyToManyField(blank=True, to='TimeSpace.ServiceIndex', verbose_name='指标列表'),
        ),
        migrations.AddField(
            model_name='hostgroup',
            name='templates',
            field=models.ManyToManyField(blank=True, to='TimeSpace.Template', verbose_name='主机组模板'),
        ),
        migrations.AddField(
            model_name='host',
            name='host_group',
        ...
        migrations.AddField(
            model_name='eventlog',
            name='host',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TimeSpace.Host', verbose_name='主机'),
        ),
        migrations.AddField(
            model_name='eventlog',
            name='trigger',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='TimeSpace.Trigger', verbose_name='触发器'),
        ),
        migrations.AddField(
            model_name='action',
            name='host_groups',
        ...
        migrations.AddField(
            model_name='action',
            name='hosts',
            field=models.ManyToManyField(blank=True, to='TimeSpace.Host', verbose_name='主机'),
        ),
        migrations.AddField(
            model_name='action',
            name='operations',
            field=models.ManyToManyField(to='TimeSpace.ActionOperation', verbose_name='ActionOperation'),
        ),
        migrations.AddField(
            model_name='action',
            name='triggers',
            field=models.ManyToManyField(blank=True, help_text='想让哪些trigger出发当前报警动作', to='TimeSpace.Trigger', verbose_name='触发器'),
        ),
    ]
