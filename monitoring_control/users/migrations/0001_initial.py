    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name', models.CharField(default='', max_length=50, verbose_name='名称')),
                ('mobile', models.CharField(blank=True, max_length=11, null=True, verbose_name='电话号码')),
                ('image', models.ImageField(default='image/default.png', upload_to='image/%Y/%m', verbose_name='个人图像')),
                ('type', models.IntegerField(choices=[(0, '普通用户'), (1, '管理员')], default=0, verbose_name='用户类型')),
